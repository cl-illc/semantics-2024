...
%&= \mathbb E_{q_\lambda(z|x)} \left[  \log p_\theta(x|z)  \pdv{\lambda}\log q_\lambda(z|x)- C_\rho(x) \right] + \mathbb E_{q_\lambda(z|x)} \left[  C_\rho(x) \right] \\
%&= \mathbb E_{q_\lambda(z|x)} \left[  \log p_\theta(x|z)  \pdv{\lambda}\log q_\lambda(z|x)- C_\rho(x) \right] + C_\rho(x)
\end{aligned}
\end{equation}
